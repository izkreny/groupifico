...
class Event < ApplicationRecord
  ...
  validates_associated :group, :address, :creator, :manager
  validates :name, :start, :end, :group, :creator, presence: true
  validates :manager, :address, presence: true, allow_nil: true
