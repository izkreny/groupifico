...
- External HTTP is blocked in specs (WebMock `disable_net_connect!`) once the first spec needs it.
...
- Nested contexts at most two deep. Never test private methods; test through the public one or make it public.
